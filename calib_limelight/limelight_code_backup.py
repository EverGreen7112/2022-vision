...
cam = gbv.USBCamera(settings.CAMERA_PORT, gbv.CameraData(777.3291449774972,1.0402162342 , 0.86742863824, pitch_angle=math.radians(0), name="limelight"))
...
hub_obj = track_object(cam=cam, pid_vals=[94, 213, 216],
                        hue=[settings.HUE_KP, settings.HUE_KI, settings.HUE_KD], sat=[settings.SAT_KP, settings.SAT_KI, settings.SAT_KD], val=[settings.VAL_KP, settings.VAL_KI, settings.VAL_KD],
                        range=[10, 110, 90], target= gbv.GameObject(0.07362744053679986), denoise_pipe = denoise_hub)
